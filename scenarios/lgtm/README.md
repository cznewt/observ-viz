# Grafana LGTM stack — deployment profile

An observ-viz **deployment profile** (scenario). It deploys a Grafana folder
"Grafana LGTM stack" of observ-lib dashboards and ships an Alloy config for collection.
...
## Deploy
```sh
python3 scripts/deploy.py lgtm      # render + apply the boards into the "Grafana LGTM stack" folder
