# Linux desktop — deployment profile

An observ-viz **deployment profile** (scenario). It deploys a Grafana folder
"Linux desktop" of observ-lib dashboards and ships an Alloy config for collection.
...
## Deploy
```sh
python3 scripts/deploy.py linux-desktop      # render + apply the boards into the "Linux desktop" folder
