...
"Linux server" of observ-lib dashboards and ships an Alloy config for collection.
...
## Deploy
```sh
python3 scripts/deploy.py linux-server      # render + apply the boards into the "Linux server" folder
