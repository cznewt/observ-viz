# Linux Podman host — deployment profile

An observ-viz **deployment profile** (scenario). It deploys a Grafana folder
"Linux Podman host" of observ-lib dashboards and ships an Alloy config for collection.
...
## Deploy
```sh
python3 scripts/deploy.py linux-podman      # render + apply the boards into the "Linux Podman host" folder
