...
- `apt_keyring_expiry_timestamp_seconds`
...
- `batocera_os_info`
- `batocerapkg_db_timestamp_seconds`
- `batocerapkg_packages_installed`
- `batocerapkg_updates_pending`
- `body_above_horizon`
...
- `instance_name:container_cpu_usage:rate5m`
- `instance_name:container_memory_working_set_bytes:sum`
...
- `namespace_pod:container_memory_working_set_bytes:sum`
...
- `pod:container_memory_working_set:sum`
...
- `salt_job_changed_states`
- `salt_job_duration`
- `salt_job_duration_seconds`
- `salt_job_failed_states`
- `salt_job_states_changed`
- `salt_job_states_failed`
- `salt_job_states_total`
- `salt_job_success`
- `salt_job_total_states`
- `salt_minion_online`
...
- `syncthing_connections_active`
- `syncthing_db_files_updated_total`
- `syncthing_db_operation_seconds_total`
- `syncthing_db_operations_current`
...
- `syncthing_model_folder_conflicts_total`
- `syncthing_model_folder_processed_bytes_total`
- `syncthing_model_folder_pull_seconds_total`
- `syncthing_model_folder_pulls_total`
- `syncthing_model_folder_scan_seconds_total`
...
- `tempo_build_info`
- `tempo_consul_request_duration_seconds_bucket`
- `tempo_consul_request_duration_seconds_count`
- `tempo_consul_request_duration_seconds_sum`
- `tempo_discarded_spans_total`
- `tempo_distributor_bytes_received_total`
- `tempo_distributor_ingester_appends_total`
- `tempo_distributor_ingester_clients`
- `tempo_distributor_metrics_generator_clients`
...
- `tempo_distributor_traces_per_batch_bucket`
- `tempo_distributor_traces_per_batch_count`
- `tempo_distributor_traces_per_batch_sum`
- `tempo_dns_failures_total`
- `tempo_dns_lookups_total`
- `tempo_experimental_features_in_use_total`
- `tempo_feature_enabled`
- `tempo_inflight_requests`
...
- `tempo_ingester_flush_duration_seconds_count`
- `tempo_ingester_flush_duration_seconds_sum`
- `tempo_ingester_flush_failed_retries_total`
- `tempo_ingester_flush_queue_length`
- `tempo_ingester_flush_retries_total`
- `tempo_ingester_flush_size_bytes_bucket`
- `tempo_ingester_flush_size_bytes_count`
- `tempo_ingester_flush_size_bytes_sum`
- `tempo_ingester_live_traces`
- `tempo_ingester_traces_created_total`
- `tempo_kv_request_duration_seconds_bucket`
- `tempo_kv_request_duration_seconds_count`
- `tempo_kv_request_duration_seconds_sum`
- `tempo_limits_defaults`
- `tempo_limits_overrides`
- `tempo_member_consul_heartbeats_total`
- `tempo_overrides_user_configurable_overrides_list_total`
- `tempo_overrides_user_configurable_overrides_reload_failed_total`
- `tempo_querier_external_endpoint_hedged_roundtrips_total`
- `tempo_querier_ingester_clients`
- `tempo_querier_metrics_generator_clients`
- `tempo_querier_worker_request_executed_total`
- `tempo_query_frontend_actual_batch_size_bucket`
- `tempo_query_frontend_actual_batch_size_count`
- `tempo_query_frontend_actual_batch_size_sum`
- `tempo_query_frontend_connected_clients`
- `tempo_query_frontend_queries_total`
- `tempo_query_frontend_queries_within_slo_total`
- `tempo_query_frontend_queue_duration_seconds_bucket`
- `tempo_query_frontend_queue_duration_seconds_count`
- `tempo_query_frontend_queue_duration_seconds_sum`
- `tempo_query_frontend_queue_length`
- `tempo_query_frontend_retries_bucket`
- `tempo_query_frontend_retries_count`
- `tempo_query_frontend_retries_sum`
...
- `tempo_request_message_bytes_bucket`
- `tempo_request_message_bytes_count`
- `tempo_request_message_bytes_sum`
- `tempo_response_message_bytes_bucket`
- `tempo_response_message_bytes_count`
- `tempo_response_message_bytes_sum`
- `tempo_ring_members`
- `tempo_ring_oldest_member_timestamp`
- `tempo_ring_tokens_total`
- `tempo_runtime_config_hash`
- `tempo_runtime_config_last_reload_successful`
- `tempo_tcp_connections`
- `tempo_tcp_connections_limit`
- `tempo_warnings_total`
- `tempodb_backend_bytes_total`
- `tempodb_backend_hedged_roundtrips_total`
- `tempodb_backend_objects_total`
- `tempodb_blocklist_length`
- `tempodb_blocklist_poll_duration_seconds_bucket`
- `tempodb_blocklist_poll_duration_seconds_count`
- `tempodb_blocklist_poll_duration_seconds_sum`
...
- `tempodb_retention_duration_seconds_bucket`
- `tempodb_retention_duration_seconds_count`
- `tempodb_retention_duration_seconds_sum`
