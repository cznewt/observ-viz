...
addtl_paths = (
    os.path.join(os.pardir, "vector-engine/src"),  # saltext.ttp itself (for autodoc)
...
dist = distribution("saltext.vector")
...
project = "Salt observability tool based on Grafana"
author = ""
